...
export default function Timer() {
    ...
    useEffect(() => {
        let timeArray: Array<number | string> = calculateTimer(timeInMilliSeconds)
    ...
    return (
        ...
        <div>
            <div className="flex justify-end">
                <a href="https://github.com/kiron0/stopwatch" target="_blank" rel="noreferrer" title="Stopwatch">
                    <button className=" flex justify-center">
                        <img className="h-10 md:h-12 w-10 md:w-12 rotate-45" src={
                            `${theme ? 'https://img.icons8.com/nolan/344/github.png' : 'https://img.icons8.com/ios-glyphs/452/github.png'}`
                        } alt="github" />
                    </button>
                </a>
            </div>
            ...
            <div>
                <button
                    ...
                    className="h-16 w-16 top-[-.5rem] left-3 absolute"
            ...
            <main className="h-[85vh] md:h-screen flex justify-center items-center flex-col md:-mt-12">
                <section className={`flex ${theme ? 'text-white' : 'text-[#666565]'} mb-10 md:mb-5`}>
                    ...
                    <span className="text-6xl relative tracking-wide -mt-1">:</span>
                    <p className="text-6xl" id="second">{timerArray[2]}</p>
                    <span className="text-6xl relative tracking-wide -mt-1">:</span>
                    <p className="text-6xl" id="second">{timerArray[3]}</p>
                </section>
                <Controls setTimeInMilliSeconds={setTimeInMilliSeconds} />
            </main>
        </div>
